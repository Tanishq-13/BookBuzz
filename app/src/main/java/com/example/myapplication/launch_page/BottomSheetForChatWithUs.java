...
public class BottomSheetForChatWithUs extends BottomSheetDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(com.example.myapplication.R.layout.bottomsheetloaderforchatwithus, container, false);
    ...
    private void applySystemUiChanges() {
        if (getDialog() != null && getDialog().getWindow() != null && isAdded()) {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                ...
                window.setStatusBarColor(ContextCompat.getColor(requireContext(), com.example.myapplication.R.color.white));
                window.setNavigationBarColor(ContextCompat.getColor(requireContext(), com.example.myapplication.R.color.white));
            }
